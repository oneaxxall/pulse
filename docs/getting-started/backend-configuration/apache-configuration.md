...
Serving Socket behind a web server such as Apache can allow you to access the Socket server via a specific hostname, such as `socket.example.com`. If you wish, you may also choose to allow Apache to negotiate your SSL connections instead of providing your SSL certificate information to Socket.
