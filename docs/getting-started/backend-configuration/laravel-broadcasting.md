...
When using [Laravel's event broadcasting](https://laravel.com/docs/8.x/broadcasting) feature within your application, Socket is even easier to configure. First, replace the default `pusher` configuration in your application's `config/broadcasting.php` file with the following configuration:
